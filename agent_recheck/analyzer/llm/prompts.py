...
3. **价格评分**：
   - 价格分权重超过60%
   - 中小企业价格扣除政策缺失或矛盾（如"专门面向"与"价格扣除"同时存在）
   - 评分标准未量化或表述歧义（如"是否认可？"、"如何得分？"）

4. **资质要求**：
   - 业绩要求过高
   - 注册资本门槛过高
   - 认证证书超出必要范围
   - **证书设置歧义**：表述模糊（如"是否认可？"、"请确认"），导致投标人无法明确得分标准
   - **证书得分标准缺失**：未明确"最低级乃至没有该证书是否可得分"
...
6. **中小企业**：
   - 未规定中小企业价格扣除比例
   - **专门面向项目**：专门面向中小企业时不应保留价格扣除政策

7. **完整性检查**：
   - 联系方式缺失（联系人、电话、邮箱等）
   - **需补充内容**：存在"请补充"、"请填写"等占位符

8. **评分标准歧义**：
   - 评分因素之间"没有直接关联性"
   - 表述为"酌情"、"综合考虑"、"由评委"等模糊词汇
